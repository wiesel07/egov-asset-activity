package cn.com.bosssoft.egov.asset.smart.activiti.api.impl;
...
import cn.com.bosssoft.egov.asset.smart.activiti.api.IActivitiApi;
...
import cn.com.bosssoft.egov.asset.smart.activiti.biz.entity.ProcessFormParams;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.entity.ProcessResult;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.entity.TaskFormParams;
...
public class ActivitiApiImpl implements IActivitiApi {
	...
	public FormDefinitionModel getFormDefinitionModel(ProcessFormParams processFormParams) {
		...
		ProcessDefinitionModel processDefinitionModel = activitiService
				.queryProcessDefinitionByKey(processDefinitionKey);
	...
	public Map<String, Object> getTaskFormPropertiesByKey(TaskFormParams taskFormParams) {
		...
		HistoricProcessInstanceModel historicProcessInstanceModel = activitiService
				.queryHisProcessInstanceByBusinessKey(businessKey, processDefinitionKey);
		...
		Map<String, Object> actParams = activitiService.queryTaskFormPropertiesByKey(processDefinitionKey,
				activityId);
	...
	public ProcessResult doAudit(ActivitiParams activitiParams) {
		...
		String actionType = activitiParams.getActionType();
		processResult = activitiService.audit(activitiParams);
//		if (ActionType.START_PROCESS.getCode() == actionType || ActionType.COMPLETE_TASK.getCode() == actionType) {
//			processResult = activitiService.doCompleteTask(activitiParams);
//		} else if (ActionType.BACK_TO_LAST.getCode() == actionType) {
//
//		} else if (ActionType.BACK_TO_START.getCode() == actionType) {
//
//		} else if (ActionType.REJECT.getCode() == actionType) {
//
//		} else {
