...
import cn.com.bosssoft.egov.asset.smart.activiti.biz.common.enums.ActivitiError;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.common.exception.ActivitiException;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.common.utils.CollectionUtilsExt;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.common.utils.ObjectUtilsExt;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.common.utils.StringUtilsExt;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.entity.ActivitiParams;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.entity.ProcessResult;
import cn.com.bosssoft.egov.asset.smart.activiti.biz.service.IActivitiService;
...
public class ActivitiServiceImpl implements IActivitiService {
	...
	@Override
	public ProcessDefinitionModel queryProcessDefinitionByKey(String processDefinitionKey) {
	...
	@Override
	public HistoricProcessInstanceModel queryHisProcessInstanceByBusinessKey(String businessKey,
	...
	@Override
	@Transactional
	public ProcessResult audit(ActivitiParams activitiParams) {
		...
		if (ObjectUtilsExt.isNull(historicProcessInstanceModel)) {
			...
			try {
				...
				// 审批
				processResult = completeTask(processInstanceModel.getId(), processDefinitionKey, businessKey, comment,
						variables);
			...
			// 审批
			processResult = completeTask(historicProcessInstanceModel.getProcessInstanceId(), processDefinitionKey,
					businessKey, activitiParams.getComment(), variables);
		}
	 ...
	 * @author 作者：wujian
	 */
	private ProcessResult completeTask(String processInstanceId, String processDefinitionKey, String businessKey,
		...
		if (flag) {
			...
			taskModel = queryUnFinishedTaskByProcessInstanceId(processInstanceId, processDefinitionKey, businessKey);
	 ...
	 * @param comment   批注
	 */
	private ProcessResult claimAndExecution(String processInstanceId, String processDefinitionKey, String userId,
		...
		// 根据任务ID进行领取并审批
		taskManagerService.claimAndExecution(taskId, userId, variables, comment);
	...
	@Override
	public TaskModel queryUnFinishedTaskByProcessInstanceId(String processInstanceId, String processDefinitionKey,
			String businessKey) {
		...
		if (taskModels.size() > 1) {
			throw new ActivitiException(ActivitiError.UNFINISHED_TASK_OVER, processDefinitionKey, businessKey);
		}
	...
	@Override
	public Map<String, Object> queryTaskFormPropertiesByKey(String processDefinitionKey, String activityId) {

		return processDefinitionService.getTaskFormPropertiesByKey(processDefinitionKey, activityId);
	}

	@Override
	public List<ActivityModel> queryActivitiesOfProcessDefintion(String processDefinitionId) {
		// TODO Auto-generated method stub
		return processDefinitionService.queryActivitiesOfProcessDefintion(processDefinitionId);
	}
