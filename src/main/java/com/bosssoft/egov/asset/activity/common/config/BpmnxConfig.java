...
import com.bosssoft.egov.asset.activity.listener.impl.ProcessEventListener;
...
public class BpmnxConfig {
	...
	public SpringProcessEngineConfiguration processEngineConfiguration() throws Exception {
		...
		processEngineConfiguration.setDatabaseSchema(environment.getProperty("spring.jdbc.databaseSchema"));
